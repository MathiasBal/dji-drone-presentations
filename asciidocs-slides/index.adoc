...
=== WSBridge
* läuft auf Android Gerät verbunden zum Kontroller der Drohne
* verbindet sich über Netzwerk mit Gerät, auf welchem SDK App läuft
** Brücke zwischen Kontroller und SDK App
*** SDK App via USB mit PC und via WIFI mit Kontroller verbunden
